...
// const canSubmit =
//     !hasShipping || (fullName && address1 && city && postalCode && country);
...
// const handleSuccess = async (successData: PaymentIntent) => {
...
//         const productIds = response.data?.confirmPayment?.productIds ?? [];
//         if (productIds.length > 0) removeMultipleItems(productIds);
//     } catch (e: unknown) {
